...
namespace GoIdentity.Utilities.Security
{
    public static class EncryptionManager
    {
        #region Constants
        private const string passPhrase = "goidentity@7flagship";        // can be any string
        private const string saltValue = "goidentity@77salt";        // can be any string
        private const string hashAlgorithm = "SHA1";             // can be "MD5"
        private const int passwordIterations = 1;                  // can be any number
        private const string initVector = "@1i2s3u4i5t6e7v7"; // must be 16 bytes
