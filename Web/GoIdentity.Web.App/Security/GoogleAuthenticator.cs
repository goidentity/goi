...
namespace GoIdentity.Web.Security
{
    public class GoogleAuthenticator
    {
        ...
        public GoogleAuhSetupCode GenerateSetupCode(string accountTitleNoSpaces, string accountSecretKey, int qrCodeWidth, int qrCodeHeight)
        {
        ...
        /// <param name="qrCodeHeight">QR Code Height</param>
        /// <returns>SetupCode object</returns>
        public GoogleAuhSetupCode GenerateSetupCode(string issuer, string accountTitleNoSpaces, string accountSecretKey, int qrCodeWidth, int qrCodeHeight)
        {
        ...
        /// <returns>SetupCode object</returns>
        public GoogleAuhSetupCode GenerateSetupCode(string issuer, string accountTitleNoSpaces, string accountSecretKey, int qrCodeWidth, int qrCodeHeight, bool useHttps)
        {
            ...
            GoogleAuhSetupCode sC = new GoogleAuhSetupCode();
    ...
    public class GoogleAuhSetupCode
    {
